...
<div data-role="page" id="profile" >
    ...
    <label for="textarea"><strong>Comments:</strong></label>
<textarea cols="40" rows="40" name="textarea" id="textarea" placeholder="(optional)"></textarea>
...
<div class="modal" id="prompt">
  <h2>Confirmation</h2>
 <p>Please click OK to confirm your feedback</p>
